...
export default function ListaCamiones({ datos }) {
      ...
      {datos.map((item) => {
        ...
        return (
          <div
            ...
            className="bg-white border border-gray-200 rounded-xl p-3 shadow-sm hover:border-[#40916C] transition-colors cursor-pointer"
          >
