...
export default function ReporteModal({ open, reporte, onClose, onCambiarEstado }) {
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="rounded-lg bg-neutral-50 border border-neutral-100 px-3.5 py-3 flex items-start gap-2.5">
              ...
              <div>
                <p className="text-[10px] text-neutral-400 uppercase tracking-wide">Usuario</p>
                <p className="text-sm font-medium text-[#14201B]">{reporte?.nombresUsuario || "-"}</p>
                <p className="text-xs text-neutral-400 mt-0.5">
                  Rol: {reporte?.rolUsuario || "-"}   ID: {reporte?.idUsuario ?? "-"}
                </p>
              </div>
            </div>
          </div>
